...
const Hero = () => {
    ...
    <div className='flex justify-center items-center flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12 transform md:translate-y-[-25px] lg:translate-y-[-50px] translate-y-[-40px] '>
      <div className='flex-1 text-center 
      lg:text-left'>
        <motion.p variants={fadeIn('up', 0.2)}  initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }}  className='font-light leading-[2] tracking-wider'>
          Hi, my name is
          </motion.p>
        ...
        <motion.p variants={fadeIn('up', 0.5)}  initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='mb-8 max-w-lg mx-auto lg:mx-0 font-light'>
    ...
    >
      ...
      <motion.div variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='mx-auto lg:flex flex-1 max-w-[320px] lg:max-w-[482px] '>
  <img src={Image} className="md:w-full lg:max-w-[482px] transform translate-y-[-40px] w-64"/>
</motion.div>
    </div>
    </div>
    </section>
